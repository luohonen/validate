...
namespace Luohonen\Validate;

use Closure;
use Luohonen\Validate\Exception\ValidateException;
use Luohonen\Validate\Helper\Str;
use Luohonen\Validate\Validate\ValidateRule;
...
class Validate
{
    ...
    protected $typeMsg = [
          ...
          "method"           => "无效的请求类型",
          "token"            => "令牌数据无效",
          "fileSize"         => ":attribute文件超过大小限制",
          "fileExt"          => ":attribute文件格式错误",
          "fileMime"         => "不允许上传"
    ];
