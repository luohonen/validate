...
namespace Luohonen\Validate\Facade;

/**
 * @see \Luohonen\Validate\Validate
 * @mixin \Luohonen\Validate\Validate
 * @method \Luohonen\Validate\Validate rule(mixed $name, mixed $rule = '') static 添加字段验证规则
 ...
 * @method \Luohonen\Validate\Validate message(mixed $name, string $message = '') static 设置提示信息
 * @method \Luohonen\Validate\Validate scene(string $name) static 设置验证场景
 * @method bool hasScene(string $name) static 判断是否存在某个验证场景
 * @method \Luohonen\Validate\Validate batch(bool $batch = true) static 设置批量验证
 * @method \Luohonen\Validate\Validate only(array $fields) static 指定需要验证的字段列表
 * @method \Luohonen\Validate\Validate remove(mixed $field, mixed $rule = true) static 移除某个字段的验证规则
 * @method \Luohonen\Validate\Validate append(mixed $field, mixed $rule = null) static 追加某个字段的验证规则
...
class Validate
{
    ...
    /**
     * @var \Luohonen\Validate\Validate
     */
